...
`,_u=E.div`
  ...
  z-index:1;
`,Mu=({startProgress:e,duration:t})=>{const[r,n]=v.useState(!1);return v.useEffect(()=>{r||window.setTimeout(()=>n(!0),1)},[r,n]),h.jsxs(ku,{children:[h.jsx(_u,{className:r?"full":"",style:{transition:`all ${t}s linear`,width:`${e*100}%`}}),h.jsx(Tu,{})]})},$i=E.div`
  padding: 1rem 0.5rem;
  p {
    font-family: var(--font-display);
  }
...
`,zu=()=>{const e=U(su,ye),t=U(sn,ye),r=U(au),n=$e(),o=i=>{const a=new Date().getTime();n(c=>{c(Yl({interaction:i,time:a})),i.cooldown&&window.setTimeout(()=>{c(hi(i.id))},i.cooldown)})};return h.jsx(Du,{children:e.filter(i=>i.visible).map(i=>h.jsx(Nu,{cooldownStatus:i.cooldownStatus,isEnabled:r?i.enabled:!1,interaction:i.definition,toggleState:t.find(a=>a.id===i.id),onClickHandler:()=>o(i.definition)},i.id))})},Uu=E.div``,Fu=E.p`
  font-size: 1.5rem;
  font-weight: bold;
`,Bu=E.div`
  margin-top: 0.25rem;
...
`,Ju=()=>{const e=U(cn),t=U(ln)||[];return e?h.jsxs(Gu,{children:[h.jsx(Ku,{children:h.jsx(zu,{})}),h.jsxs(Yu,{children:[h.jsx("h3",{children:"stats"}),h.jsx(Xu,{children:t.map((r,n)=>h.jsx(Hu,{label:r.label,max:r.max,value:r.value,displayType:r.displayType},n))})]})]}):null},Zu=E.div`
  position: absolute;
  right: 0;
  bottom: 1rem;
  z-index: 1;
...
`,ef=E.li`
  ...
  `}
`,tf=()=>["--theme-color-primary","--theme-color-secondary","--theme-color-secondary"],rf=()=>-5+Math.random()*5,nf=e=>e*35,of=()=>{const t=U(wi,ye).filter(r=>r.label);return h.jsx(Zu,{children:h.jsx(Qu,{children:t.map((r,n)=>h.jsx(ef,{id:r.id,$bubbleColors:tf(),style:{bottom:nf(n),transform:`rotate(${rf()}deg)`},children:r.label},r.id))})})},af=E.div`
  position: absolute;
  inset: 0;
  overflow: hidden;
  background-color: var(--theme-color-primary);
...
`,mf=E.h4`
  ...
  display: inline-block;
  flex: 1;
`,ro=e=>e?new Date(e).toLocaleString("en-us"):null,gf=()=>{const e=U(cn),t=U(et),[r,n]=v.useState(!1);return e?h.jsxs(ff,{className:r?"bio-visible":"",children:[r?h.jsxs(hf,{children:[h.jsx("span",{children:e.name}),h.jsx("span",{children:e.bio})]}):h.jsxs(pf,{children:[h.jsx(mf,{children:e.name}),(t==null?void 0:t.bornOn)&&h.jsx("p",{children:`born on: ${ro(t.bornOn)}`}),(t==null?void 0:t.diedOn)&&h.jsx("p",{children:`died on: ${ro(t.diedOn)}`})]}),h.jsx(df,{onClick:()=>n(o=>!o),children:r?"X":"?"})]}):null},vf=E.header`
  position: relative;
...
`,xf=E.ul`
  list-style: none;
`,Ef=()=>{const e=U(cn),t=U(cu),r=$e(),n=(e==null?void 0:e.idx)||0;return h.jsxs(vf,{children:[h.jsx(yf,{children:h.jsx("div",{children:n+1})}),h.jsxs(bf,{children:[h.jsx(xf,{children:t.map((o,i)=>h.jsx(Sf,{$isActive:i===n,onClick:()=>r(pi(i)),children:i+1},i))}),h.jsx(ho,{to:"/about",children:h.jsx("h1",{children:"BrowserBuddy"})})]}),h.jsx(wf,{children:h.jsx(gf,{})})]})},$f=E.div`
  position: absolute;
  inset: 0;
  margin: auto auto;
  overflow: hidden;
...
`,Pf=E.div`
  flex: 0 0 33%;
  position: relative;
`,Of=()=>h.jsxs($f,{children:[h.jsx(Ru,{}),h.jsx(Ef,{}),h.jsx(Cf,{children:h.jsx(uf,{})}),h.jsx(Pf,{children:h.jsx(Ju,{})})]}),jf=()=>h.jsxs(wa,{children:[h.jsx(yr,{path:"/about",element:h.jsx(gu,{})}),h.jsx(yr,{path:"/",element:h.jsx(Of,{})})]});const If=Sc`
  *{
    margin: 0;
    padding: 0;
    outline:0;
...
`;Ri.createRoot(document.getElementById("root")).render(h.jsx(X.StrictMode,{children:h.jsx(vs,{store:yu,children:h.jsxs(Pa,{children:[h.jsx(jf,{}),h.jsx(If,{})]})})}));
